...
from ..options import SpecificOptions
...
class AbstractAPI(object):
    ...
    def __init__(self, specification, base_path=None, arguments=None,
        ...
        self.options = SpecificOptions(options, oas_version=self.specification.version)
    ...
    def get_request(self, *args, **kwargs):
        """
        This method converts the user framework request to a SpecificRequest.
        """
    ...
    def get_response(self, response, mimetype=None, request=None):
        """
        This method converts the SpecificResponse to a user framework response.
        ...
        :type response: SpecificResponse
        :type mimetype: str
        """
    ...
    def get_specific_response(cls, response, mimetype=None):
        """
        This method converts the user framework response to a SpecificResponse.
        :param response: A response to cast.
        """
